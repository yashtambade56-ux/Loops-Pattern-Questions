...
2. Skipping items using continue
3. Pattern creation using nested loops
4. Mathematical logic: factorial, prime numbers, Fibonacci
5. Counting digits manually
6. Working with number ranges
7. Star and pyramid pattern logic
8. Loop-based addition and iteration techniques
